    ...
    >
        ...
        <div className="space-y-2">
          ...
          <div>
            ...
            <div className="relative h-2 bg-gray-700 rounded">
              <div className="absolute inset-0 bg-gray-500 rounded" style={{ width: `${targetIntensity * 10}%` }} />
              <div className="absolute inset-0 bg-blue-500 rounded" style={{ width: `${currentIntensity * 10}%` }} />
            </div>
          </div>
          ...
          <div>
            ...
            {remainingTime !== undefined && (
              <div className="text-xs text-gray-400">
                {remainingTime > 0 ? `${remainingTime.toFixed(1)}s remaining` : 'Time's up!'}
              </div>
            )}
          </div>
        </div>
      ...
      <div className="border-t border-gray-700 pt-3">
        <div className="flex justify-between items-baseline">
          ...
          <span className={cn('text-2xl font-bold', getMatchColor(metrics.overallScore))}>
        ...
        <div className="mt-3 p-2 bg-gray-800 rounded text-sm">
          ...
          <ul className="text-xs space-y-1 text-gray-300">
            ...
            {metrics.intensityMatch < 70 && (
              <li>• {currentIntensity < targetIntensity ? 'Increase' : 'Decrease'} your emotional intensity</li>
            )}
