...
class Recording(Base):
    """Model for storing recording information."""
    ...
    analyses = relationship("RecordingAnalysis", back_populates="recording", cascade="all, delete-orphan")

class RecordingAnalysis(Base):
    """Model for storing recording analysis results."""
