...
async def join_session(request: SessionJoinRequest) -> Dict:
    ...
    try:
        # Add collaborator with session ID
        ...
        return {
            "status": "success",
            "message": f"User {request.username} joined session {request.session_id}",
...
async def websocket_endpoint(websocket: WebSocket, session_id: str, user_id: str):
    ...
    try:
        ...
        collaboration_service.remove_collaborator(user_id, session_id)
