...
const PRACTICE_MODES: PracticeMode[] = [
  { id: 'standard', name: 'Standard', description: 'Practice with full feedback and guidance' },
  { id: 'timed', name: 'Timed', description: 'Practice with time limits per line' },
  { id: 'blind', name: 'Blind', description: 'Practice without seeing the next lines' },
  { id: 'memory', name: 'Memory', description: 'Practice with lines temporarily hidden' }
];
...
export function ScriptDisplay({
  ...
  const [showAnnotationInput, setShowAnnotationInput] = useState<string | null>(null);
  ...
  useEffect(() => {
    ...
    const currentElement = document.getElementById(`script-line-${currentLineId}`);
    if (currentElement) {
  ...
  }, [currentLineId, lines, onLineSelect, onLineComplete, showAnnotationInput, showKeyboardShortcuts]);
        ...
        <div className="flex justify-between items-center">
                ...
                <div
                  ...
                  className={cn(
                    'w-2 h-2 rounded-full transition-all duration-200',
                    {
                      ...
                      'bg-gray-300': !completedLineIds.includes(line.id) && line.id !== currentLineId
                    }
                  )}
                />
              ))}
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              disabled={!currentLineId || currentLineId === lines[lines.length - 1].id}
              className="p-2 rounded hover:bg-gray-100 disabled:opacity-50"
            >
              <svg
                className="w-5 h-5"
