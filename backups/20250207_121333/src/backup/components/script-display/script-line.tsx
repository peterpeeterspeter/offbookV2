...
const emotionColors: Record<Emotion, { bg: string; text: string; border: string }> = {
  ...
  surprise: { bg: 'bg-green-100', text: 'text-green-800', border: 'border-green-300' },
  disgust: { bg: 'bg-orange-100', text: 'text-orange-800', border: 'border-orange-300' },
