...
type VisualizationMode = 'spectrum' | 'waveform' | 'stereo';
...
export const AudioVisualizer: React.FC<AudioVisualizerProps> = ({
  ...
  useEffect(() => {
    ...
    const drawSpectrum = () => {
      ...
      for (let i = 0; i < bufferLength; i++) {
        ...
        const normalizedValue = (dbValue + 140) * heightScale;
  ...
  }, [analyzer, width, height, theme, mode]);

  return (
    <Card className={cn('p-4', className)}>
      <Tabs value={mode} onValueChange={(value) => setMode(value as VisualizationMode)}>
